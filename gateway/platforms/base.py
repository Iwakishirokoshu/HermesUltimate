...
def _thread_metadata_for_source(source, reply_to_message_id: str | None = None) -> dict | None:
    ...
    metadata = {}
    if platform_name == "telegram" and gateway_bot_id:
        metadata["telegram_gateway_bot_id"] = str(gateway_bot_id)
...
class BasePlatformAdapter(ABC):
    ...
    def build_source(
        ...
        message_id: Optional[str] = None,
        gateway_bot_id: Optional[str] = None,
    ) -> SessionSource:
        ...
        return SessionSource(
            ...
            gateway_bot_id=str(gateway_bot_id) if gateway_bot_id else None,
        )
