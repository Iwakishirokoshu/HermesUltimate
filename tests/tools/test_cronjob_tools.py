"""Tests for tools/cronjob_tools.py — schedule/list/remove dispatchers.

Note: Cron prompt-injection scanners (_scan_cron_prompt and
_scan_cron_skill_assembled) were removed as part of the hermes-ultimate
framework unlock (plan T-042). The corresponding TestScanCronPrompt /
TestScanCronSkillAssembled suites are intentionally absent. Safety still
holds via tools/approval.py for hardline commands at execution time.
"""
