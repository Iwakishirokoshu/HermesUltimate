...
export interface EnvVarInfo {
  ...
  tools: string[];
  advanced: boolean;
  /** True when the backend is surfacing a safe built-in default rather than a saved .env value. */
  is_default?: boolean;
  /** Origin of the value shown by the dashboard: .env, stack.env, or default. */
  source?: "env" | "stack_env" | "default" | "";
