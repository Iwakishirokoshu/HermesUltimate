...
from tools.cloak._cdp_client import cdp_version
...
CLOAK_NAVIGATE_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "timeout": {"type": "integer", "description": "Seconds to wait for document.readyState to become complete.", "default": 30},
        },
        "required": ["url"],
    },
}
...
CLOAK_SCREENSHOT_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            "include_data": {
                "type": "boolean",
                "description": "Include base64 PNG data inline. Defaults to false to avoid large/sensitive tool output.",
                "default": False,
            },
        },
        "required": [],
...
CLOAK_COOKIES_EXPORT_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "include_cookies": {
                "type": "boolean",
                "description": "Include cookie values inline. Defaults to false; the full jar is written to the returned path.",
                "default": False,
            },
        },
        "required": [],
...
registry.register(
    ...
    handler=lambda args, **kw: cloak_screenshot(bool(args.get("include_data", False))),
    check_fn=check_cloak_requirements,
    is_async=True,
    emoji="C",
)
...
registry.register(
    ...
    handler=lambda args, **kw: cloak_cookies_export(args.get("domain"), bool(args.get("include_cookies", False))),
    check_fn=check_cloak_requirements,
    is_async=True,
    emoji="C",
)
