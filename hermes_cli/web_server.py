...
from hermes_cli.web_api.cloak import router as _cloak_router
from hermes_cli.web_api.decepticon import router as _decepticon_router
from hermes_cli.web_api.gateway import router as _gateway_router
...
app.include_router(_cloak_router)
