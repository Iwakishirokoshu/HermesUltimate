...
DEFAULT_CONFIG = {
    ...
    "memory": {
        ...
        # External memory provider plugins are disabled in HermesUltimate.
        # Leave empty to use built-in MEMORY.md / USER.md plus HermesVault.
        "provider": "",
    },
...
OPTIONAL_ENV_VARS = {
    ...
    "NINEROUTER_API_KEY": {
        "description": "9Router API key generated by the Hermes Ultimate stack",
    ...
    "NINEROUTER_BASE_URL": {
        "description": "9Router OpenAI-compatible base URL for the local Hermes stack",
        "prompt": "9Router base URL",
        "url": None,
        "password": False,
        "category": "provider",
    ...
    "NOTLETTERS_API_KEY": {
        "description": "NotLetters API key for registration skills and mailbox verification codes",
        "prompt": "NotLetters API key",
        "url": "https://notletters.com/",
        "tools": ["notletters"],
        "password": True,
        "category": "tool",
    },
    "REGISTRATION_EMAIL": {
        "description": "Default mailbox email for registration skills",
        "prompt": "Registration mailbox email",
        "url": None,
        "password": False,
        "category": "tool",
        "advanced": True,
    ...
    "REGISTRATION_EMAIL_PASSWORD": {
        "description": "Default mailbox password for registration skills",
        "prompt": "Registration mailbox password",
        "url": None,
        "password": True,
        "category": "tool",
        "advanced": True,
...
def set_config_value(key: str, value: str):
    ...
    api_keys = [
        ...
        'TOOL_GATEWAY_USER_TOKEN', 'TAVILY_API_KEY', 'NOTLETTERS_API_KEY',
        'REGISTRATION_EMAIL', 'REGISTRATION_EMAIL_PASSWORD',
