...
PUBLIC_API_PATHS: frozenset[str] = frozenset({
    # Minimal unauthenticated health probe for installer and compose gates.
    # Returns only {"ok": true}; richer status remains at /api/status.
    "/api/health",
...
# Prefix-matched public API static mounts. Keep this for static assets only;
# stateful APIs and websockets must stay behind the normal dashboard gate.
