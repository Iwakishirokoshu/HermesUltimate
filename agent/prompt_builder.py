...
# Context-injection scanner removed by hermes-ultimate framework unlock
# (plan T-040). SOUL.md / .hermes.md / AGENTS.md / CLAUDE.md / .cursorrules
# now load verbatim into the system prompt. Operator-level safety still
# guards execution via tools/approval.py for hardline commands. See
# docs/README-unlock.md for rationale.
