...
#
# Usage:
#   iex (irm https://raw.githubusercontent.com/Iwakishirokoshu/HermesUltimate/main/scripts/install.ps1)
#
...
$RepoUrlSsh = "git@github.com:Iwakishirokoshu/HermesUltimate.git"
$RepoUrlHttps = "https://github.com/Iwakishirokoshu/HermesUltimate.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/Iwakishirokoshu/HermesUltimate/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/Iwakishirokoshu/HermesUltimate/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/Iwakishirokoshu/HermesUltimate/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/Iwakishirokoshu/HermesUltimate/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
